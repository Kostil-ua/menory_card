...
#Містить в собі питання, правильну відповідь, та 3 неправильних відповідей
class Question():
...
# таймер (прихов програми на деякий час)
def rest():
    card_win.hide()
    n = box_min.value()
    sleep(n * 60)
...
def back_menu():
    ...
    text = f"Всого відповідей: {count_ask}\n"\
...
# Очищення полей з новим запитанням
def clear():
    le_quest.clear()
    le_right_ans.clear()
    le_wrong_ans1.clear()
